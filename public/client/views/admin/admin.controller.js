...
(function () {
    ...
    function AdminController($scope, $rootScope, $location, $sessionStorage, PostService, UserService,
        ...
        if($sessionStorage.hasOwnProperty("user")) {
            ...
            $scope.profileName = $sessionStorage.user.firstname + " " + $sessionStorage.user.lastname;
            $scope.loginCount = 0;
            $scope.uploadSize = 0;
            ...
            function publishPost(i, size){
                ...
                PostService.createPost(post).then(function(response){
                    if(i<=4000){
                        $scope.uploadSize =  i + " posts of size 256 bytes has been uploaded " +
                            "\n Total file upload size = " + size + "bytes";
                        publishPost(i+1, size + 256);
                    }
                });
            }
